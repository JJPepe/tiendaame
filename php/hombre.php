                    ...
                    <div class="fraccionArticulo">
                        ...
                        <div>
                            ...
                            <form class="añadirCarrito" action="agregarCarrito.php" method="POST">
                                <button type="submit" name="ropaID" value="1">
                ...
                <div class="articulo">
                    ...
                    <div class="fraccionArticulo">
                        ...
                        <div>
                            ...
                            <form class="añadirCarrito" action="agregarCarrito.php" method="POST">
                                <button type="submit" name="ropaID" value="2">
                                    <a>Añadir al carrito</a>
                                </button>
                            </form>
                ...
                <div class="articulo">
                    ...
                    <div class="fraccionArticulo">
                        ...
                        <div>
                            ...
                            <form class="añadirCarrito" action="agregarCarrito.php" method="POST">
                                <button type="submit" name="ropaID" value="3">
                                    <a>Añadir al carrito</a>
                                </button>
                            </form>
                ...
                <div class="articulo">
                    ...
                    <div class="fraccionArticulo">
                        ...
                        <div>
                            ...
                            <form class="añadirCarrito" action="agregarCarrito.php" method="POST">
                                <button type="submit" name="ropaID" value="4">
                                    <a>Añadir al carrito</a>
                                </button>
                            </form>
                ...
                <div class="articulo">
                    ...
                    <div class="fraccionArticulo">
                        ...
                        <div>
                            ...
                            <form class="añadirCarrito" action="agregarCarrito.php" method="POST">
                                <button type="submit" name="ropaID" value="5">
                                    <a>Añadir al carrito</a>
                                </button>
                            </form>
                ...
                <div class="articulo">
                    ...
                    <div class="fraccionArticulo">
                        ...
                        <div>
                            ...
                            <form class="añadirCarrito" action="agregarCarrito.php" method="POST">
                                <button type="submit" name="ropaID" value="6">
                                    <a>Añadir al carrito</a>
                                </button>
                            </form>
                ...
                <div class="articulo">
                    ...
                    <div class="fraccionArticulo">
                        ...
                        <div>
                            ...
                            <form class="añadirCarrito" action="agregarCarrito.php" method="POST">
                                <button type="submit" name="ropaID" value="7">
                                    <a>Añadir al carrito</a>
                                </button>
                            </form>
                ...
                <div class="articulo">
                    ...
                    <div class="fraccionArticulo">
                        ...
                        <div>
                            ...
                            <form class="añadirCarrito" action="agregarCarrito.php" method="POST">
                                <button type="submit" name="ropaID" value="8">
                                    <a>Añadir al carrito</a>
                                </button>
                            </form>
