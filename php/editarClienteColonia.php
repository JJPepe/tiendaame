...
<body>
    ...
    <main>
        ...
        <?php
            ...
            // CACHAR LOS DATOS DEL FORM ANTERIOR EDITARCLIENTEMUNICIPIO.PHP
            ...
            else
            {
                ...
                $consultaColonia = "SELECT *
                                     FROM colonia col
                                     INNER JOIN  municipio mun
                                     ON col.municipioFK = mun.municipioID                                     
                                     WHERE col.municipioFK='$municipioID' AND mun.ESTADOREG='1' ORDER BY colonia";

                $resultadoColonia = mysqli_query($conexion,$consultaColonia);

                // CONSULTA ESTADO
                $consultaEstado = "SELECT * FROM estado WHERE estadoID='$estado'";

                $resultadoEstado = mysqli_query($conexion,$consultaEstado);
                $filasEstado = mysqli_fetch_array($resultadoEstado);

                // CONSULTA MUNICIPIO
                $consultaMunicipio = "SELECT municipio FROM municipio WHERE municipioID='$municipioID'";
        ...
        <!-- RENGLONES QUE SE LLENARAN AUTOMATICAMENTE -->
            ...
            <div class="elPapu">            
                <form action="actualizarCliente.php" method="POST">
                    ...
                    <div class="elPapuContenido">
                        ...
                        <div class="margen">
                            <select name="actualizarMunicipio">                                
                                        <option value="<?php echo $municipioID; ?>"><?php echo $filasMunicipio['municipio']; ?></option>                                                                     
                            </select>                            
                        </div>
                        <div class="tituloDatos">
                                Colonia:
                    ...
                    <br>
                    <button type="submit" class="nuevoreg">Actualizar</button>
                    <input type="checkbox" id="nuevoadmin">
