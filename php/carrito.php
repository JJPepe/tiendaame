...
<head>
    ...
    <?php
        ...
        else
        {
            ...
            //CONSULTA ARICULOS QUE TIENE EN EL CARRITO EL CLIENTE
            $consultaRopaCarrito = "SELECT * FROM articulos_carrito WHERE pedido='NOCONFIRMADO' AND CLIENTEFK='$datos'";
            $resultadoRopaCarrito = mysqli_query($conexion,$consultaRopaCarrito);
...
<body>
    ...
    <div class="contenedorArticulos">
                ...
                <div class="subcontenedorArticulosCategorias">
                    <?php
                        $contador = 1;
                        while($filasCategoria=mysqli_fetch_array($resultadoRopaCarrito))
                        {    
                ...
                <div class="añadirCarrito" style="text-align:center;">
                    <h2 class="nombre-articulo">Total en carrito: 
                        <?php
                            //CONSULTA SUMA DEL TOTAL DE LOS ARTICULOS
                            $consultaTotal = "SELECT SUM(importe) FROM DETALLECARRITO WHERE CLIENTEFK='$datos' AND pedido='NOCONFIRMADO' AND ESTADOREG='1'";
                    ...
                    <form class="añadirCarrito" action="comprar.php" method="POST">                       
                        <button style="max-width: 15rem;" type="submit" name="comprar" value="<?php echo $pedidoID; ?>">
                            comprar
                        </button>
                        <br><br>
                    </form>
